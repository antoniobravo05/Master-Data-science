...
##### 4. Bloque de revisi??n basica del dataset #####
...
##### 6. Bloque de analisis de exito de campa??a #####
...
##### 8. Bloque de creaci??n de variable Acci??n #####
...
##### 9. Bloque de An??lisis de ??xito diferenciando los que han sido accionados de los que no #####
...
##### 10. Bloque de An??lisis de Resultados por grupos y fecha #####
